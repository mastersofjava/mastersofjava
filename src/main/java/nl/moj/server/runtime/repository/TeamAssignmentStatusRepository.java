...
public interface TeamAssignmentStatusRepository extends JpaRepository<TeamAssignmentStatus, Long> {
    ...
    List<TeamAssignmentStatus> findByAssignmentAndCompetitionSession(Assignment assignment,
    ...
    Optional<TeamAssignmentStatus> findByAssignmentAndCompetitionSessionAndTeam(Assignment assignment,
            CompetitionSession competitionSession, Team team);
